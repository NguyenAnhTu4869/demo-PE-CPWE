...
const handleGet = async (values, setReturnData, setPagination, departmentId) => {
    var paramsValue = {
        searchKey: values === null || values.searchKey === null ? null : values.searchKey,
        departmentId: values === null || values.departmentId === null ? departmentId : values.departmentId,
